...
const InputCheckbox: React.FC<Props> = (props) => {
  ...
  const rootClassName = `w-4 h-4 rounded bg-white text-blue-600 dark:text-blue-600 shadow-sm focus:ring focus:ring-offset-0 focus:ring-blue-200 focus:ring-opacity-50 ${
